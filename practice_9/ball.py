"""
ball.py — Класс мяча для игры Moving Ball
==========================================
...
class Ball:
    """
    Красный мяч размером 50x50 (радиус 25).
    
    Координаты (x, y) — это ЦЕНТР мяча.
    Поэтому:
    ...
    def move(self, dx, dy):
        """
        Сдвигаем мяч на (dx, dy) пикселей.
        
        Перед сдвигом проверяем: не выйдет ли мяч за границу.
        Если выйдет — просто не двигаемся (игнорируем ввод).
